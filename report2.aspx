...
<%
	...
	Dim kcidstr as String =""
	Dim abc as String
	Dim jmlhal as Integer = 0
	Dim jmlh as Integer = 0
	Dim sisa as Integer = 0
	Dim p, pp as Integer
	Dim jmldataperhal as Integer = 18
...
'** Cek branch/KC
	...
	If myReader.HasRows Then
		While myReader.Read()
			kcidstr = myReader("br_id").ToString()
		End While
	End If
	myConn.Close()
	kcid = Val(kcidstr)
	...
	jmlh = jmldata \  jmldataperhal
	jmlhal = jmlh
	sisa = jmldata mod jmldataperhal
	If sisa > 0 Then
		jmlhal = jmlh + 1
	End If
...
<table id="kctbarutab" style="text-align: left; margin-left: 50px; margin-right: auto; margin-top: 0;" width="910px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="35px">
		<td style="padding-left: 0px; text-align: left; font-size: 1.1em; vertical-align: top" width="100px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top; font-size: 1.1em;" width="780px">
			<FONT face="Calibri" color="#000">
<%
...
<table style="margin-left: 50px;" width="1300px" align="center" cellpadding="0" cellspacing="0" border="1" bgcolor="#FFF" >
	<tr height="20px" align="left" style="background-color: #DEDEDE">
		...
		<td rowspan="2"style="font-family: Calibri; font-size: 1.0em;text-align: center;" width="180px">
			<FONT face="Calibri" color="#000"><b>Cabang</b></FONT>
		</td>  
		<td rowspan="2"style="font-family: Calibri; font-size: 1.0em;text-align: center;" width="250px">
			<FONT face="Calibri" color="#000"><b>KCP/KLN/KK</b></FONT>
		</td>
		<td rowspan="2"style="font-family: Calibri; font-size: 1.0em;text-align: center;" width="100px">
			<FONT face="Calibri" color="#000"><b>NPP</b></FONT>
		</td>
		<td rowspan="2"style="font-family: Calibri; font-size: 1.0em;text-align: center;" width="200px">
			<FONT face="Calibri" color="#000"><b>Nama</b></FONT>
		</td>
		<td rowspan="2" style="font-family: Calibri; font-size: 1.0em;text-align: center;" width="150px">
			<FONT face="Calibri" color="#000"><b>Posisi/Jabatan</b></FONT>
		</td>  
		...
		<td rowspan="2" style="font-family: Calibri; font-size: 1.0em;text-align: center;" width="120px">
			<FONT face="Calibri" color="#000"><b>Tgl Efektif</b></FONT>
		</td>
		<td rowspan="2"style="font-family: Calibri; font-size: 1.0em;text-align: center;" width="120px">
			<FONT face="Calibri" color="#000"><b>Tgl Berakhir</b></FONT>
		</td>		
	</tr>
	<tr height="20px" align="left" style="background-color: #DEDEDE">
		<td style="font-family: Calibri; font-size: 1.0em;text-align: center;" width="100px">
			<FONT face="Calibri" color="#000"><b>PGS</b></FONT>
		</td>
		<td style="font-family: Calibri; font-size: 1.0em;text-align: center;" width="100px">
			<FONT face="Calibri" color="#000"><b>Definitive</b></FONT>
		</td>  		
	</tr>
<%
		Dim oDate As DateTime

		p = ((c - 1)*jmldataperhal) + 1
		pp = p + jmldataperhal - 1
		if jmldata <= pp Then
			pp = jmldata
		End If
...
%>			
		...
		<td style="padding-left: 5px; font-family: Calibri; font-size: 1.0em;text-align: left; line-height:120%">
			<FONT face="Calibri" color="#000">
<%
			If a=1 Then
				Response.Write(cabangx)
...
<%
				abc = jabatanx(a)
				If abc isNot Nothing Then
					If abc.Contains("PGS") Then
						Response.Write("V")
					End If
				End if
				'Response.Write(abc)
