...
function editdata(id, nourut, jmlrow)
{
	...
	xhttp.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
			...
			for (m = 1; m <= jmlrow; m++) {
				rowx = "row"+m;
				document.getElementById(rowx).style.backgroundColor='#FFFFFF';
			}
			rowx = "row"+nourut;
         ...
         <div class="sidebar__inner">
            ...
            <div class="submenu">
             ...
             <ul>
               ...
               <li>
                  <a href="daftarkct.aspx?page=1&cari=" class="active">
...
$('#calendar-demo').dcalendar(); //creates the calendar
	...
	<tr height="40px">
		...
		<td colspan="3" style="padding-left: 0px; text-align: left;">
			<a id="batalbtn" href="" class="medium button orange" onclick="clearparam(); return false;">Batal</a>
		</td>
	</tr>
	<tr height="10px">
		<td colspan="4">
...
%>
	<tr id="row<% Response.Write(bb)%>" height="30px">
		...
		<td style="padding-left: 5px; font-family: Calibri; font-size: 1.1em;text-align: left;"><% Response.Write (brklnx(i) & "--" & jmldata & "--" & itop & "--" & idx(i)) %></td>
