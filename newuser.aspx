...
<table id="kctbarutab" style="text-align: left; margin-left: 250px; margin-right: auto; margin-top: 0;" width="860px" border="0" cellspacing="0" cellpadding="0">
	<tr height="20px">
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="550px">
			<FONT face="Calibri" color="#000">
				<input style="font-family: Calibri; font-size: 1.0em; width: 250px" type="text" id="nama" name="nama" class="textboxmid">
			</FONT>
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Calibri" color="#000">
				<select STYLE="color: #000000; background-color: #ffffff; font-size: 0.9em; width: 150px; height: 26px;" id="soflow1" name="level" data-placeholder="Nama Bank" tabindex="1"> 
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Calibri" color="#000">
				<input style="font-family: Calibri; font-size: 1.0em; width: 150px" type="text" id="username" name="username" class="textbox">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Calibri" color="#000">
				<input style="font-family: Calibri; font-size: 1.0em; width: 150px" type="text" id="passwd" name="passwd" class="textbox">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
