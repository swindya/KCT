...
{
	var outx = "";
	var kcku = document.getElementsByName("barukc")[0].value;
	xhttp = new XMLHttpRequest();
	xhttp.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
			//document.getElementById("txtHint").innerHTML = this.responseText;
	...
	var getstr = "savekcgo.aspx?kc="+kcku
...
function addkcp()
{
	var outx = "";
	var kcku = document.getElementsByName("barukc")[0].value;
	var kcpku = document.getElementsByName("barukcp")[0].value;
	if (kcku==null || kcku=="")
	{
		alert("Pilih dulu Cabang-nya.");
		return false
	}
	xhttp = new XMLHttpRequest();
	xhttp.onreadystatechange = function() {
	...
	var getstr = "savekcpgo.aspx?kc="+kcku+"&kcp="+kcpku
	xhttp.open("GET", getstr, true);
	xhttp.send();
...
<script>
function viewkcp(mykc)
{
//alert(mykc)
	var outx;
	var linkx = "getkcp.aspx?namakc="+mykc;
	xhttp = new XMLHttpRequest();
	xhttp.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
			//document.getElementById("txtHint").innerHTML = this.responseText;
			outx = this.responseText;
			document.getElementById("languageList2").innerHTML = outx;
			//document.getElementById("languageList2").value = outx;
...
<%
	...
	Dim jmlkc as Integer = 0
	Dim jmlkcp as Integer = 0
	Dim namakc(100) as String
	Dim namakcp(1000) as String
	...
	Dim setmenu as String = "daftarKCP"
...
<%
		...
		'
			...
			If myReader.HasRows Then
				While myReader.Read()
					a = a + 1
					namakc(a) = myReader("br_nama").ToString()
				End While
				jmlkc = a
			End If
			myConn.Close()
...
<table id="kctbarutab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: 0;" width="860px" border="0" cellspacing="0" cellpadding="0">
	<tr height="20px">
		<td colspan="4" style="padding-left: 0px; text-align: left; font-size: 1.6em">
			<FONT face="Arial" color="#44AA44"><b>DATA KC/KCP</b></FONT>
		</td>
	</tr>
	<tr height="40px">
	...
	<tr height="50px">
		<td style="padding-left: 0px; text-align: left; font-size: 1.0em; vertical-align: top" width="120px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="710px">
			<FONT face="Calibri" color="#000">
				<input style="font-size: 1.0em" type="text" list="languageList1" onchange="viewkcp(this.value);" id="barukc" name="barukc" class="textbox">
				<datalist id="languageList1">
<%
				For a=1 to jmlkc
					Response.Write("<option>" & namakc(a) & "</option>")
				Next a
%>
				</datalist>
			</FONT>
			&nbsp;
			<a id="barukcsave" href="#" class="small button green" onclick="addkc();"><i class="fas fa-save fa-sm"></i>&nbsp;&nbsp;Simpan</a>
	...
	<tr height="50px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Calibri" color="#000">
				<input style="font-size: 1.0em" type="text" list="languageList2" id="barukcp" name="barukcp" class="textbox">
				<datalist id="languageList2">
<%
				For a=1 to jmlkcp
					Response.Write("<option>" & namakcp(a) & "</option>")
				Next a
%>
				</datalist>
			</FONT>
			&nbsp;
			<a id="barukcp" href="#" class="small button green" onclick="addkcp();"><i class="fas fa-save fa-sm"></i>&nbsp;&nbsp;Simpan</a>
		</td>
	</tr>
	<tr height="10px">
		<td colspan="4">
