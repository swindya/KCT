...
<%
	...
	Dim setmenu as String = "laporankcpperkc"
...
<form method="post" autocomplete="off" name="reportfrm" id="reportfrm" target="_blank" action="report2.aspx" enctype="multipart/form-data">
<table id="kctbarutab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: 0;" width="880px" border="0" cellspacing="0" cellpadding="0">
	<tr height="20px">
		<td colspan="3" style="padding-left: 0px; text-align: left; font-size: 1.6em">
			<FONT face="Arial" color="#44AA44"><b>View Data Entry per Cabang</b></FONT>
		</td>
	</tr>
	<tr height="50px">
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="700px">
			<FONT face="Calibri" color="#000">
			<select STYLE="color: #000000; background-color: #ffffff; font-size: 1.0em; width: 250px" id="soflow2" name="cabang" data-placeholder="Jenis" tabindex="2"> 
				<option value="" >&nbsp;&nbsp;</option>
<%
				for a=1 to jmldata
%>
				<option value="<% Response.Write(namaoutlet(a)) %>"><% Response.Write(namaoutlet(a)) %></option>
<%
				next a
%>
			</select>			
