         ...
         <div class="sidebar__inner">
            ...
            <div class="submenu">
             ...
             <ul>
               ...
               <li>
                  <a href="main.aspx?page=1&cari=" class="active">
...
'If Request.QueryString("cari") Then
...
'** Baca semua data sesuai Query			
			...
			If NOT carival is nothing Then
				'SQL1 = "SELECT id FROM kct WHERE (nama LIKE '%" & carival & "%' OR npp LIKE '%" & carival & "%')"
				SQL1 = "SELECT top(20) id FROM kct WHERE id NOT IN (SELECT top (" & pagerows & ") id FROM kct " & _
						"WHERE (nama LIKE '%" & carival & "%' OR npp LIKE '%" & carival & "%')" & _
						"ORDER BY id DESC) ORDER BY id DESC"
			Else
				SQL1 = "SELECT top(20) id FROM kct WHERE id NOT IN (SELECT top (" & pagerows & ") id FROM kct ORDER BY id DESC) ORDER BY id DESC"
			End IF
            ...
            If myReader.HasRows Then
                While myReader.Read()
					itop = myReader("id").ToString()
				End While
			End If
			myConn.Close()


			SQL2 = "SELECT TOP (20) kln.kln_nama AS brnama, jabatan.jabatan_nama AS jabatan, kct.nama AS nama, " & _
					...
					" WHERE (kct.id <= " & itop & ") ORDER BY id DESC"
...
<form method="post" name="viewdatafrm" id="viewdatafrm" action="daftarbmnadd.php" enctype="multipart/form-data">
<table id="paramtab" style="text-align: left; margin-left: 250px; margin-right: auto; margin-top: auto;" width="950px" border="0" cellspacing="0" cellpadding="0">
	<tr height="20px">
		<td colspan="4" style="padding-left: 0px; text-align: left; font-size: 1.6em">
	...
	<tr height="40px">
		<td style="padding-left: 0px; text-align: left;">
			<a href="#" class="medium button green" onclick="viewfilter();">Cari / Filter</a>
		</td>
		<td colspan="2" style="padding-left: 0px; text-align: left;">
			<a href="" class="medium button orange" onclick="clearparam(); return false;">Clear Parameter</a>
		</td>
	</tr>
	<tr height="20px">
		<td colspan="3" style="padding-left: 20px; text-align: left;">
...
%>
	<tr>
		...
		<td style="padding-left: 5px; font-family: Calibri; font-size: 1.1em;text-align: left;"><% Response.Write (brklnx(i) & "--" & pageno & "--" & jmlpage) %></td>
