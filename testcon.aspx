...
Response.Write("TES KONEKSI" & "<br>")
Response.Write("=========" & "<br><br>")	

    Try
        If (aaa=1)
			'myConn = New SqlConnection("Data Source=DESKTOP-S7N8DF9;Initial Catalog=KCT;User ID=sa;Password=sa;")
			myConn = New SqlConnection("Data Source=DESKTOP-S7N8DF9;Initial Catalog=KCT;User ID=Administrator;Password=bni1234/;")
			myCmd = myConn.CreateCommand

'** Baca semua data sesuai Query			
			SQL0 = "SELECT * FROM [kct] WHERE (id<1580)"
