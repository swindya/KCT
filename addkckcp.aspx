...
<table id="kctbarutab" style="text-align: left; margin-left: 0px; margin-right: auto; margin-top: 0;" width="860px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Calibri" color="#000">
				<input style="font-family: Calibri; font-size: 1.0em" type="text" list="languageList" id="baruoutlet" name="baruoutlet" class="textbox">
...
%>
			...
			&nbsp;
			<a id="barubbm" href="outlet.aspx" class="small button green" onclick="addoutlet();"><i class="fas fa-plus fa-sm"></i></a>
