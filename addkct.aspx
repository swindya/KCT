...
<table id="kctbarutab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: 0;" width="860px" border="0" cellspacing="0" cellpadding="0">
	<tr height="20px">
		<td colspan="4" style="padding-left: 0px; text-align: left; font-size: 1.6em">
			<FONT face="Arial" color="#44AA44"><b>TAMBAH DATA KCT</b></FONT>
		</td>
	</tr>
	<tr height="30px">
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="550px">
			<FONT face="Calibri" color="#000">
				<input style="font-size: 1.0em" type="text" id="barunpp" name="barunpp" class="textboxmid" onchange="getnpp(this.value);">
			</FONT>
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Calibri" color="#000">
				<input style="font-size: 1.0em; width: 300px" type="text" id="barunama" name="barunama" class="textbox" onchange="getnama(this.value);">
			</FONT>
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Calibri" color="#000">
				<input style="font-size: 1.0em; width: 300px" list="posisiList" type="text" id="baruposisi" name="baruposisi" class="textbox">
				<datalist id="posisiList">
<%
...
%>
	...
	<!--tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Calibri" color="#000">
				<input style="font-family: Calibri; font-size: 1.0em" list="statusposisiList" type="text" id="barustatusposisi" name="barustatusposisi" class="textbox">
				<datalist id="statusposisiList">
					<option>PGS</option>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Calibri" color="#000">
				<input style="font-size: 1.0em; width: 300px; vertical-align: top" type="text" list="languageList" id="baruoutlet" name="baruoutlet" class="textbox">
...
%>
			...
			&nbsp;
			<a id="barukc" href="daftarkckcp.aspx">
			<img id="uploadPreview0" src="./img/add224.png" height="26px" width="25px"/><br/>
			</a>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Calibri" color="#000">
				<input style="font-size: 1.0em; width: 300px" type="text" id="barunosk" name="barunosk" class="textbox">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="340px">
			<FONT face="Calibri" color="#000">
				...
				<input autocomplete="off" placeholder="" STYLE="padding-left:5px; font-size:1.0em; border:1px solid #ababab; width: 140px" class="inp-icon" id="barutglefektif" name="barutglefektif" type="text">
...
$('#calendar-demo').dcalendar(); //creates the calendar
			...
			<FONT face="Calibri" color="#000">
				<!--input style="font-family: Calibri; font-size: 0.9em" type="text" id="datepicker-ex30" name="barubbmtglbayar" class="textboxtgl"-->
				<input autocomplete="off" placeholder="" STYLE="padding-left:5px; font-size:1.0em; border:1px solid #ababab; width: 140px" class="inp-icon" id="barutglend" name="barutglend" type="text">
<script src="js/jquery-1.11.1.min.js"></script>
<script src="datepicker4/dcalendar.picker.js"></script>
<script>
$('#barutglend').dcalendarpicker();
$('#calendar-demo').dcalendar(); //creates the calendar
</script>
			</FONT>
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; padding-top: 5px; text-align: left; vertical-align: top">
			<FONT face="Calibri" color="#000">
				<textarea STYLE="padding-left: 5px; color: #000000; border:1px solid #ababab; font-weight: normal; font-size:1.0em; line-height: 110%;" id="baruket" name="baruket" rows="3" cols="64"></textarea>
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: auto; padding-top: 5px; text-align: left; vertical-align: top">
			<table id="file1" style="text-align: left; margin-left: 0px; margin-right: auto; margin-top: auto; vertical-align: top" border="0" cellspacing="0" cellpadding="0">
				<tr height="42px">
					<td style="padding-left: 0px; padding-top: auto; vertical-align: top; text-align: left;">
						<FONT face="Calibri" color="#000">
							<input style=" vertical-align: top; font-size: 1.0em" id="uploadImage1" name="uploadImage1" type="file" onchange="PreviewImage(1);" onclick="resetpic();" />
						</FONT>
					</td>
...
<table style="margin-left: 270px;" width="940px" align="center" cellpadding="2" cellspacing="2" border="0" bgcolor="#FFF" >
	...
	<tr height="38px" align="left">
		<td style="font-family: Calibri; font-size: 1.0em;text-align: left;" width="100px">
			<a id="barusave" href="#" class="medium button green" onclick="addkct();"><i class="fas fa-save fa-sm"></i>&nbsp;&nbsp;Simpan</a>
		</td>                        	
	</tr>
</table>
</form>
